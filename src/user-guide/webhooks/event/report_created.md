---
title: Webhook Source report_created
summary: A webhook event for any new scanner report saved to the Trivial Security cloud storage.
authors:
  - Chris Langton
date: 2023-04-26
---

# Webhook Source report_created

A webhook event for any new scanner report saved to the Trivial Security cloud storage.
