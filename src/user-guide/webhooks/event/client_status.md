---
title: Webhook Source client_activity
summary: Customer managed Client server status webhooks
authors:
  - Chris Langton
date: 2023-04-26
---

# Webhook Source client_activity

Customer managed Client server status webhooks often needed for customers to perform tasks on their infrastructure linked to user actions performed in the Trivial Security Dashboard
