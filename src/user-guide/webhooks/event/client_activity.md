...
summary: Customer managed Client server activity webhooks to capture audit related data
authors:
  - Chris Langton
date: 2023-04-26
---
...
Customer managed Client server activity webhooks to capture audit related data
