  ...
  security_headers_config {
    ...
    content_security_policy {
      content_security_policy = join("; ", [
        ...
        "script-src-elem 'self' https://trivialsec.statuspage.io https://cdn.jsdelivr.net 'unsafe-inline'",
        "font-src 'self' https://fonts.gstatic.com data:",
        "object-src 'none'",
        "form-action 'none'",
        "worker-src 'self' blob:",
        "frame-src https://*.statuspage.io https://cdn.forms-content.sg-form.com https://www.youtube-nocookie.com",
